    ...
    return(
        <div className='timesProfile flexColumn'>
            ...
            <div className='summary'>
                ...
                <p>Started as self taught taking online courses until i joined iciis, praesentium, placeat, incidunt saepe dolorem repellendus illo magni possimus assumenda. Quos cupiditate suscipit a, dolores </p>
            </div>
        </div>
    );
}
